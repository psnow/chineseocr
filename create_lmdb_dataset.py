...
OUT_PATH = r"C:\work\github\OCR\Synthetic_Chinese_String_Dataset\lmdb"
IN_PATH = r"C:\work\github\OCR\Synthetic_Chinese_String_Dataset\crnn_labels\train.txt"
PREFIX = r"C:\work\github\OCR\Synthetic_Chinese_String_Dataset\images"
...
def createDataset(outputPath, imagePathList, labelList, lexiconList=None, checkValid=True):
    ...
    env = lmdb.open(outputPath, map_size=15000000000)
    cache = {}
    cnt = 1
...
if __name__ == '__main__':
    ...
    if not os.path.exists(OUT_PATH):
        os.mkdir(OUT_PATH)
    imgdata = open(IN_PATH,encoding='UTF-8-sig')
